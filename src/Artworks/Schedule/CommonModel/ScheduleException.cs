...
namespace Artworks.Schedule.CommonModel
{

    /// <summary>
    /// 执行计划异常。
    /// </summary>
    public class ScheduleException : ArtworksException
    {
        #region Ctor
        /// <summary>
        /// Initializes a new instance of the <c>ScheduleException</c> class.
        /// </summary>
        public ScheduleException() : base() { }
        /// <summary>
        /// Initializes a new instance of the <c>ScheduleException</c> class with the specified
        /// error message.
        /// </summary>
        ...
        public ScheduleException(string message, System.Exception innerException) : base(message, innerException) { }
        /// <summary>
        /// Initializes a new instance of the <c>ScheduleException</c> class with the specified
        ...
        public ScheduleException(string format, params object[] args) : base(string.Format(format, args)) { }
