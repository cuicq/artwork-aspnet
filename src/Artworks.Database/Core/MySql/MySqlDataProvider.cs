...
namespace Artworks.Database.Core.MySql
{
    ...
    public class MySqlDataProvider : DataProvider
    {
        ...
        {
            MySqlPlug.MySqlClient.MySqlConnection conn = new MySqlPlug.MySqlClient.MySqlConnection(connectionString);
            return conn;
        }
        ...
        {
            DbConnection con = new MySqlPlug.MySqlClient.MySqlConnection(connectionString);
        ...
        */
        ...
        {
            DbDataAdapter dap = new MySqlPlug.MySqlClient.MySqlDataAdapter();
