...
namespace Artworks.Database.CommonModel
{
    ...
    /// 表示该类为数据库异常类
    /// </summary>
    public class OperationException : ArtworksException
    {
        #region Ctor
        /// <summary>
        /// Initializes a new instance of the <c>OperationException</c> class.
        /// </summary>
        public OperationException() : base() { }
        /// <summary>
        /// Initializes a new instance of the <c>OperationException</c> class with the specified
        /// error message.
        /// </summary>
        ...
        public OperationException(string format, params object[] args) : base(string.Format(format, args)) { }
