...
namespace Artworks.Infrastructure.Application.Query.CommonModel
{
    ...
    public class PagedResult<T> : IEnumerable<T>, ICollection<T>
    {
        ...
        public PagedResult(int totalRecords, int pageNumber, int pageSize, IList<T> data)
        {
        ...
        public PagedResult(int totalRecords, int totalPages, int pageNumber, int pageSize, IList<T> data)
        {
